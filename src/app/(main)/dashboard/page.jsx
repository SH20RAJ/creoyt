    ...
    <div className="dark:bg-gray-900">
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <div className="grid auto-rows-min gap-4 md:grid-cols-3">
          <div className="aspect-video rounded-xl bg-muted/50 dark:bg-gray-800" />
          <div className="aspect-video rounded-xl bg-muted/50 dark:bg-gray-800" />
          <div className="aspect-video rounded-xl bg-muted/50 dark:bg-gray-800" />
        </div>
        <div className="min-h-[100vh] flex-1 rounded-xl bg-muted/50 dark:bg-gray-800 md:min-h-min" />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-6">
          {/* Channel Analysis Card */}
          <div className="group relative overflow-hidden rounded-xl bg-card p-6 hover:shadow-lg transition-all duration-300">
            <div className="absolute right-0 top-0 translate-x-4 -translate-y-4">
              <div className="h-24 w-24 rounded-full bg-indigo-500/10" />
            </div>
          ...
          <div className="group relative overflow-hidden rounded-xl bg-card p-6 hover:shadow-lg transition-all duration-300">
            <div className="absolute right-0 top-0 translate-x-4 -translate-y-4">
              <div className="h-24 w-24 rounded-full bg-blue-500/10" />
            </div>
            <div className="relative">
          ...
          <div className="group relative overflow-hidden rounded-xl bg-card p-6 hover:shadow-lg transition-all duration-300">
            <div className="absolute right-0 top-0 translate-x-4 -translate-y-4">
              <div className="h-24 w-24 rounded-full bg-purple-500/10" />
            </div>
            <div className="relative">
