      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Choose the perfect plan to help grow your YouTube channel with our AI-powered tools.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          ...
          <div className="relative p-8 rounded-2xl bg-card border border-border hover:shadow-xl transition-shadow">
            ...
            <p className="text-muted-foreground mb-6">For professional creators</p>
            <div className="mb-6">
            ...
            <button className="w-full py-3 rounded-lg bg-indigo-500 text-white font-medium hover:bg-indigo-600 transition-colors">
              Contact Sales
            </button>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-8">
            <div className="text-left">
              <h3 className="text-xl font-semibold mb-2 text-foreground">Can I upgrade or downgrade my plan?</h3>
            ...
            <div className="text-left">
              <h3 className="text-xl font-semibold mb-2 text-foreground">Do you offer refunds?</h3>
