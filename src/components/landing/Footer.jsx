        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              <Link href="https://discord.gg/tV6UKHspsZ" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                <IconBrandDiscord />
              </Link>
              <Link href="https://github.com/SH20RAJ/creoyt" target="_blank" rel="noopener noreferrer" className="hover:text-white">
              ...
              <Link href="https://www.linkedin.com/in/sh20raj/" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
